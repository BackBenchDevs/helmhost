//! Framebuffer pixel cache for CopyRect.

use helmhost_core::Rect;

/// RGBA8 framebuffer cache (tightly packed rows).
#[derive(Debug, Clone)]
...
impl FramebufferCache {
    ...
    pub fn copy_rect(&mut self, dst: Rect, src_x: i32, src_y: i32) -> Result<Vec<u8>, String> {
